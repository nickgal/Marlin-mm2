...
#define STRING_CONFIG_H_AUTHOR "Nick Gal" // Who made the changes.
...
#define TEMP_BED_RESIDENCY_TIME 25  // (seconds)
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 1600, 460 }
